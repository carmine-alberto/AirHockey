...
const SkyBoxModel  SkyBoxToLoad1 = {"SkyBoxCube.obj", OBJ, {"skybox/space/right.png", "skybox/space/left.png", "skybox/space/top.png", "skybox/space/bot.png", "skybox/space/front.png", "skybox/space/back.png"}};
    ...
    void updateGPUData(uint32_t currentImage) {
        ...
        glm::mat4 viewMatrices[NUM_VIEWS + 1] = { //TODO Refactor into different states
            ...
            glm::lookAt(glm::vec3(halfTableLength + 0.8f, cameraHeight, 0.0f), //Right player
                        glm::vec3(0.0f, halfTableHeight, 0.0f),
                        glm::vec3(0.0f, 1.0f, 0.0f)),
            glm::lookAt(glm::vec3(0.0f, 0.8f, 2.4f), //Victory
                        glm::vec3(0.0f, halfTableHeight, 0.0f),
                        glm::vec3(0.0f, 1.0f, 0.0f)),
        };
        ...
        switch (state) {
            ...
            case RESET:{
                ...
                if (glfwGetKey(window, GLFW_KEY_V))
                    view = static_cast<views>((view) % NUM_VIEWS + 1);
                break;
        }
            case PLAYING:{
